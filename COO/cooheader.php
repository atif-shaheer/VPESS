        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hi! COO</div>
              ...
              <a href="coologout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="cooindex.php"> <img alt="image" src="../assets/img/Capture-removebg-preview-removebg-preview (1).png" class="header-logo" /> <span
                class="logo-name">Hi! COO</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="cooindex.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="addoperationhead.php" class="nav-link"><i data-feather="user"></i><span>Add Operation Head</span></a>
            </li>
            <li class="dropdown">
              <a href="servicehead.php" class="nav-link"><i data-feather="user"></i><span>Service Head</span></a>
            </li>
            <li class="dropdown">

              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="flag"></i><span>Under Service Head</span></a>

              <ul class="dropdown-menu">

                <li><a class="nav-link" href="cooareaheadrpt.php">Area Head Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Area Head</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="cooengineerrpt.php">Engineer Report</a></li>
                    <li><a class="nav-link" href="cootengineerrpt.php">Trainee Engineer Report</a></li>
                    <!-- <li>
                      <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Area Head</span></a>
                      <ul class="dropdown-menu">
            ...
            <li class="dropdown">
              <a href="#" class="nav-link"><i data-feather="user"></i><span>Small Project Head</span></a>
            </li>

            <li class="dropdown">

                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                    data-feather="flag"></i><span>Under Small Project Head</span></a>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Relational Manager</span></a>
                        <ul class="dropdown-menu">
            ...
            <li class="dropdown">
              <a href="#" class="nav-link"><i data-feather="user"></i><span>Mega Project Head</span></a>
            </li>

            <li class="dropdown">

                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                    data-feather="flag"></i><span>Under Mega Project Head</span></a>
