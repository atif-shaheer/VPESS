      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_1280.png"
                class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hi! CEO</div>
              ...
              <a href="ceologout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="ceoindex.php"> <img alt="image" src="../assets/img/Capture-removebg-preview-removebg-preview (1).png" class="header-logo" /> <span
                class="logo-name">Hi! CEO</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="ceoindex.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="coo.php" class="nav-link"><i data-feather="user"></i><span>COO</span></a>
            </li>
            <li class="dropdown">

              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="flag"></i><span>Under COO</span></a>

              <ul class="dropdown-menu">

                <li><a class="nav-link" href="serviceheadrpt.php">Service Head Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Service Head</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="ceoareaheadrpt.php">Area Head Report</a></li>
                    <li>
                      <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Area Head</span></a>
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="ceoengineerrpt.php">Engineer Report</a></li>
                        <li><a class="nav-link" href="ceotengineerrpt.php">Trainee Engineer Report</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="#">Small Project Head Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Small Project Head</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#">Relational Manager Report</a></li>
                    <li>
                      <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Relational Manager Head</span></a>
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="#">Project Engineer Report</a></li>
                        <li>
                          <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Project Engineer</span></a>
                          <ul class="dropdown-menu">
                            <li><a class="nav-link" href="#">Engineer Report</a></li>
                            <li><a class="nav-link" href="#">Trainee Engineer Report</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="#">Mega Project Head Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Small Project Head</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#">Regional Manager Report</a></li>
                    <li>
                      <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Regional Manager</span></a>
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="#">Project Engineer Report</a></li>
                        <li>
                          <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under Project Engineer</span></a>
            ...
            <li class="dropdown">
              <a href="#" class="nav-link"><i data-feather="user"></i><span>CTO</span></a>
            </li>
            

            <li class="dropdown">
              <a href="#" class="nav-link"><i data-feather="user"></i><span>CFO</span></a>
            </li>

            <li class="dropdown">
              <a href="#" class="nav-link"><i data-feather="user"></i><span>CMO</span></a>
            </li>

            <li class="dropdown">
              <a href="bdo.php" class="nav-link"><i data-feather="user"></i><span>BDO</span></a>
            </li>
            <li class="dropdown">

              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="flag"></i><span>Under BDO</span></a>

              <ul class="dropdown-menu">

                <li><a class="nav-link" href="ceobdobdmrpt.php">BDM Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under BDM</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="ceobdobderpt.php">BDE Report</a></li>
                    <li>
                      <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under BDE</span></a>
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="ceocustomerdetails.php">Customers Detail</a></li>
                        <li><a class="nav-link" href="#">Customers Report</a></li>
                        <!-- <li><a class="nav-link" href="ceotengineerrpt.php">Trainee Engineer Report</a></li> -->
                      </ul>
                    </li>
                  </ul>
