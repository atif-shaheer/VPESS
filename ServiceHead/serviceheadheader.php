...
<head>
  ...
  <title>Service Head Panel</title>
  <!-- General CSS Files -->
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hi! Service Head Manager</div>
              ...
              <a href="serviceheadlogout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="serviceheadindex.php"> <img alt="image" src="../assets/img/Capture-removebg-preview-removebg-preview (1).png" class="header-logo" /> <span
                class="logo-name">Hi! SHM</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="serviceheadindex.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="areahead.php" class="nav-link"><i data-feather="user"></i><span>Area Head</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="flag"></i><span>Under Area Head</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="serviceheadengineerrpt.php">Engineer Report</a></li>
                <li><a class="nav-link" href="serviceheadtengineerrpt.php">Trainee Engineer Report</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="shcustomerrpt.php" class="nav-link"><i data-feather="user"></i><span>Customer Report</span></a>
            </li>
