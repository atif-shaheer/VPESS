        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Hardware Site</h6>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    customer_work.site_id = engineers.site_id AND engineers.ausername = area_head.username AND customer_work.site_id = '$site_id' AND c_id = '$c_id' AND engineers.work_status = 'Hardware'";
