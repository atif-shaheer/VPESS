...
if (isset($_POST['material_expenses'])) {
    ...
    $sql = "INSERT INTO material_expenses (site_name, date, approved_by, material_name, amount, Invoice) 
            VALUES ('$siteName', '$date', '$approved_by', '$material_name', '$amount', '$invoice')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Your Material Expense Added Successfully!');window.location.href='MEexp.php'</script>";
    } else {
...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="MEexp.php">Material Expence</a></li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Add Your Material Expense</h6>
                </div>
                <div class="card-body">
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="cc-payment" class="control-label mb-1">Material Name</label>
                                <input id="material_name" name="material_name" required class="form-control" aria-invalid="false" placeholder="Material Name">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="cc-payment" class="control-label mb-1">Amount</label>
                                <input id="amount" name="amount" type="number" required class="form-control" aria-invalid="false" placeholder="Amount">
                            </div>
                            <div class="form-group col-md-2">
                            ...
                            <label for="exampleInputPassword1" style="color: white;">Password</label>
                                <button class="form-control" type="submit" name="material_expenses" class="btn btn-primary" style="background-color:#6777ef;color:white;" >ADD</button>
                            </div>
                        </div>
                    </form>
                </div>
