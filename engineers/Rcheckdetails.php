        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Room/Hotel Expense</h6>
                    <div class="col-3 col-md-3 col-lg-3">
                        <a href="RAexp.php" name="submit" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                <div class="table-responsive">
                    <div style="height: 500px;overflow-y:scroll;">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <?php
                                    $query = "SELECT * FROM room_expenses";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td>' . $row['date'] . '</td>';
                                            echo '<td>' . $row['time'] . '</td>';
                                            echo '<td>' . $row['hotel_room_details'] . '</td>';
