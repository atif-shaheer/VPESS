...
if (isset($_POST['meal'])) {
    ...
    $sql = "INSERT INTO room_expenses (site_name, date, time, hotel_room_details, price_cost, Invoice) 
            VALUES ('$siteName', '$date', '$time', '$hotel_room_details', '$priceCost', '$invoice')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Your Room Expense Added Successfully!');window.location.href='Rexp.php'</script>";
    } else {
...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="Rexp.php">Room Expence</a></li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Add Your Room Expense</h6>
                </div>
                <div class="card-body">
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="cc-payment" class="control-label mb-1">Hotel Room Details</label>
                                <input id="hotel_room_details" name="hotel_room_details" required class="form-control" aria-invalid="false" placeholder="Room">
                            </div>
                            <div class="form-group col-md-2">
