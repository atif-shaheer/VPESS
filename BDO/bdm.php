<?php include('bdoheader.php'); ?>

<?php
// Check if the form has been submitted
if (isset($_POST['addbdm'])) {
  ...
  $sql = "INSERT INTO bdm (username, employee_code, password, status, postdate) 
          VALUES ('$username', '$employee_code', '$password', '$status', '$postdate')";
    if ($conn->query($sql) === TRUE) {
    echo "BDM Added successfully";
    } else {
  ...
  echo "<script>alert('BDM Added successfully!');window.location.href='$_SERVER[PHP_SELF]'</script>";
  exit();
}
?>
                        ...
                        <form method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-footer text-right">
                                    <button type="submit" name="addbdm" class="btn btn-primary">Add</button>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        ...
                                        $status = "active";
                                        if ($status == "active") {
                                            $sql = "UPDATE bdm SET status='inactive' WHERE id='$id'";
                                            $result = mysqli_query($conn, $sql);
                                            if ($result) {
                                                echo "<script>location.href='bdm.php';</script>";
                                            }
                                        }
                                        }
