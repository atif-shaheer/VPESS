        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hi! BDO</div>
              ...
              <a href="bdologout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="bdoindex.php"> <img alt="image" src="../assets/img/Capture-removebg-preview-removebg-preview (1).png" class="header-logo" /> <span
                class="logo-name">Hi! BDO</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="bdoindex.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="bdm.php" class="nav-link"><i data-feather="user"></i><span>BDM</span></a>
            </li>
            <li class="dropdown">

              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="flag"></i><span>Under BDM</span></a>

              <ul class="dropdown-menu">

                <li><a class="nav-link" href="bdobderpt.php">BDE Report</a></li>

                <li>
                  <a href="#" class="menu-toggle nav-link has-dropdown"><span>Under BDE</span></a>
                  <ul class="dropdown-menu">
                  <li><a class="nav-link" href="bdocustomerdetails.php">Customer Details</a></li>
                    <li><a class="nav-link" href="ceoareaheadrpt.php">Customer Report</a></li>
                    <!-- <li>
