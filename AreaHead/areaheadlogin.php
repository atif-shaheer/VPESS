...
<?php
session_start();
if(isset($_POST['areaheadlogin'])) {
  $empcode = mysqli_real_escape_string($conn, $_POST['employee_code']);
  $password = mysqli_real_escape_string($conn, $_POST['password']);
  $query = "SELECT * FROM area_head WHERE employee_code = '$empcode' AND password = '$password'";
  ...
  if(mysqli_num_rows($result) == 1) {
    ...
    header('Location: areaheadindex.php');
  } else {
    echo '<div class="alert alert-danger col-md-12" role="alert">';
    echo 'Invalid Employee Code or Password...! Please Try Again With Correct.';
    echo '</div>';
  }
}
mysqli_close($conn);
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" method="post">
                    ...
                    <div class="form-group">
                      <button type="submit" name="areaheadlogin" class="btn btn-primary btn-block">Login</button>
                    </div>
                    <!-- <hr>
