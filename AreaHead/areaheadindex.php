                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Engineers</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        ...
                        $sql = "SELECT COUNT(*) as count FROM engineers WHERE ausername = '$username' AND type='Engineer'";
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Earnings (Monthly)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Trainee Engineers</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        ...
                        $sql = "SELECT COUNT(*) as count FROM engineers WHERE ausername = '$username' AND type='Trainee Engineer'";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $row = $result->fetch_assoc();
                            $count = $row['count'];
