        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="bdelogout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="bdeindex.php"> <img alt="image" src="../assets/img/Capture-removebg-preview-removebg-preview (1).png" class="header-logo" /> <span
                class="logo-name"><?php echo $_SESSION['username'] ?></span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="bdeindex.php" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="verifyjob.php" class="nav-link"><i data-feather="check-circle"></i><span>Verify Job</span></a>
            </li>
            <li class="dropdown">
              <a href="newjobs.php" class="nav-link"><i data-feather="flag"></i><span>New Jobs</span></a>
            </li>
            <li class="dropdown">
              <a href="bdeaddnewcustomer.php" class="nav-link"><i data-feather="plus"></i><span>Add New Job</span></a>
            </li>
            <li class="dropdown">
              <a href="addcustomer.php" class="nav-link"><i data-feather="check-square"></i><span>Completed Jobs</span></a>
            </li>
            <li class="dropdown">
              <a href="addcustomer.php" class="nav-link"><i data-feather="git-pull-request"></i><span>Work Order Request</span></a>
            </li>
            <li class="dropdown">
              <a href="addcustomer.php" class="nav-link"><i data-feather="clipboard"></i><span>Bill Booked Request</span></a>
            </li>
            <li class="dropdown">
              <a href="addcustomer.php" class="nav-link"><i data-feather="plus"></i><span>Add Customers</span></a>
            </li>
            <li class="dropdown">
              <a href="bdecustomerrpt.php" class="nav-link"><i data-feather="user"></i><span>Customers Report</span></a>
            </li>
